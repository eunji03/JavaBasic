...
public class DoubleEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("dnum3: "+(double)i3);
		System.out.println("dnum4: "+dnum4);
		System.out.println("dnum4: "+(double)i2);
		
		System.out.println("-2147483648: = "+(double)i4);
